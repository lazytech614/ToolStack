...
import { EXAMPLE_MARKDOWN } from "@/constants/configs/examples";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {/* Word wrap */}
            <button
              style={wordWrap ? activeBtnStyle : btnBase}
            ...
            {/* Line numbers */}
            <button
              style={lineNumbers ? activeBtnStyle : btnBase}
            ...
            {/* Reset */}
            <button style={btnBase} onClick={() => setValue(EXAMPLE_MARKDOWN)} title="Reset">
              <RefreshCw size={12} />
              Reset
            </button>
          </div>
      ...
      >
        ...
        <span style={{ fontSize: 11, color: c.textFaint, marginLeft: "auto" }}>GFM · Mermaid</span>
      </div>
    </div>
  );
}
