...
const LINE_STYLES: Record<DiffLine["type"], string> = {
  added:
    "bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border-l-2 border-emerald-500",
          ...
          {view === "unified" ? (
            ...
            <div className="grid grid-cols-2 gap-4">
              {(["removed", "added"] as const).map((type) => (
                ...
                >
                  <div className="border-b border-zinc-200 bg-zinc-50 px-3 py-1.5 dark:border-zinc-800 dark:bg-zinc-900">
                    <span
                      className={cn(
                        "text-xs font-medium",
                        type === "added"
