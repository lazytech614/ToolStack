...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-white py-10 md:py-20 lg:py-28 dark:bg-black">
      <Container>
        <div className="flex flex-col justify-between gap-x-4 lg:flex-row">
          <div className="space-y-6 lg:w-1/2">
            <div className="mb-6 inline-flex items-center rounded-full border border-purple-500/20 bg-purple-500/10 px-4 py-2 text-sm font-medium text-purple-600 dark:border-purple-500/20 dark:bg-purple-500/10 dark:text-purple-400">
